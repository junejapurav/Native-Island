        ...
        <footer>
            ...
            <div className="lowerfooter">
                ...
                <div>
                    ...
                    <p><i className="fa-solid fa-envelope"></i> <a href="mailto:bharat.juneja@proskart.com">bharat.juneja@proskart.com</a></p>
                    <p><i className="fa-solid fa-location-dot"></i> Gurgaon, Haryana</p>
                </div>
            </div>
            <div className="copyright">
                © 2021 Copyright:  <a href="https://proskart.com/">Proskart.com</a>
            </div>
        </footer>
    )
}
